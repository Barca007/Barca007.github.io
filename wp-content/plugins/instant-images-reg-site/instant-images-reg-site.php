...
Description: Стоковые фотографии загружается в медиатеку одним щелчком мыши.
...
$myUpdateChecker = Puc_v4_Factory::buildUpdateChecker(
	'https://api.turnkey.reg.ru/wordpress/plugins/updates/instant-images.json',
	__FILE__,
	'instant-images'
);
...
class InstantImages {
	...
	private function constants() {
		define( 'INSTANT_IMG_TITLE', __( 'Instant Images', 'instant-images' ) );
		$upload_dir = wp_upload_dir();
	...
	public function instant_images_add_action_links( $links ) {
		$mylinks = array( '<a href="' . INSTANT_IMG_WPADMIN_URL . '">Загрузить фото</a>' );
