...
$options = array (
	...
	array( "name" => "wrap-general",
		...
		array( "name" => "general-1",
			...
			array( "name" =>esc_html__( "Show Vk Icon", $themename ),
									 "id" => $shortname . "_show_vk_icon",
									 "type" => "checkbox",
									 "std" => "on",
									 "desc" =>esc_html__( "Here you can choose to display the Vk Icon on your homepage. ", $themename ) ),
			...
			array( "name" =>esc_html__( "Vk Profile Url", $themename ),
                   "id" => $shortname . "_vk_url",
                   "std" => "#",
                   "type" => "text",
                   "validation_type" => "url",
					 				 "desc" =>esc_html__( "Enter the URL of your Vk Profile. ", $themename ) ),
