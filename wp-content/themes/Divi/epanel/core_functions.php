									...
									if ( in_array( $value['type'], array( 'text', 'textlimit', 'textarea', 'select', 'checkboxes', 'different_checkboxes', 'colorpicker', 'textcolorpopup', 'upload', 'callback_function', 'et_color_palette', 'password' ) ) ) { ?>
											<div class="et-epanel-box">
												...
												<div class="et-box-content">
													...
													<?php
														if ( et_get_option( 'divi_logo' ) ) $logoUrl = et_get_option( 'divi_logo' );
														else $logoUrl = get_site_url() . '/wp-content/themes/Divi/images/logo.png';
													?>
														<input style="display:none;" id="logoUrl" value="<?php echo $logoUrl; ?>"/>
														<img id="img-logo" style="height:48px;float: left; margin-right:20px;position:relative; top:-10px" src="<?php echo $logoUrl ?>" alt="logo"/>
														<input style="display:none;" id="<?php echo esc_attr( $value['id'] ); ?>" class="et-upload-field" type="text" size="90" name="<?php echo esc_attr( $value['id'] ); ?>" value="<?php echo esc_url( et_get_option( $value['id'], '', '', false, $is_new_global_setting, $global_setting_main_name, $global_setting_sub_name ) ); ?>" />
														<div class="et-upload-buttons">
															<input id="divi_logo_set_button" style="margin: 0 !important;" class="et-upload-image-button" type="button"<?php echo et_core_esc_previously( $et_upload_button_data ); ?> value="<?php esc_attr_e( 'Upload', $themename ); ?>" />
															<span id="divi_logo_reset"style="margin: 0 0 0 5%;" class="et-upload-image-reset"><?php esc_html_e( 'Reset', $themename ); ?></span>
														</div>
